...
function updateInputFromKeys() {
  ...
  if (keys['a'] || keys['arrowleft']) input.steering = 1;
  else if (keys['d'] || keys['arrowright']) input.steering = -1;
...
function handlePhysicsControls() {
  ...
  vehicle.setSteeringValue(input.steering * maxSteerVal, 0);
